...
const meetingLinkSchema = z.object({
  ...
  pptDriveLink: z.string().url('Invalid PPT Drive URL').optional().or(z.literal('')),
...
export async function POST(request: NextRequest) {
  try {
    ...
    const meetingLink: MeetingLink = {
      ...
      pptDriveLink: validated.pptDriveLink && validated.pptDriveLink.trim() !== '' ? validated.pptDriveLink : undefined,
