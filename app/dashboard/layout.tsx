  ...
  return (
    <header className="sticky top-0 z-20 border-b border-[#E5E7EB] bg-white/80 backdrop-blur-lg">
      <div className="flex flex-col gap-3 px-4 py-3 sm:gap-4 sm:px-8 sm:py-4">
        {/* Single compact row on mobile: menu + greeting + actions */}
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            type="button"
            className="lg:hidden shrink-0 p-2 rounded-xl border border-[#E5E7EB] bg-white text-[#0F172A] shadow-sm touch-manipulation"
        ...
        {/* Full-width subtitle so it does not squeeze beside icons */}
        <p className="text-xs leading-snug text-[#6B7280] sm:text-sm sm:leading-relaxed">{subtitle}</p>
