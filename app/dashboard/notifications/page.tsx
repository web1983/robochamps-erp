...
const items = [
  { title: 'Weekly digest', body: 'Your attendance pulse is synced every morning with the main ERP workspace.', time: 'Today · 08:00' },
  { title: 'Meeting reminders', body: 'Join links stay pinned in Meeting Links; PPTs open in a new tab when provided.', time: 'Yesterday' },
  { title: 'Reports', body: 'Submit training logs from Quick Actions or the Reports area to keep admins aligned.', time: 'This week' },
];
  ...
  return (
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-[#6B7280] mt-1">High-signal updates for your teaching workspace.</p>
      </motion.div>
